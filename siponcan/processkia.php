...
move_uploaded_file($_FILES["img1"]["tmp_name"],"files/kia/".$_FILES["img1"]["name"]);
move_uploaded_file($_FILES["img2"]["tmp_name"],"files/kia/".$_FILES["img2"]["name"]);

move_uploaded_file($_FILES["img3"]["tmp_name"],"files/kia/".$_FILES["img3"]["name"]);
move_uploaded_file($_FILES["img4"]["tmp_name"],"files/kia/".$_FILES["img4"]["name"]);
move_uploaded_file($_FILES["img5"]["tmp_name"],"files/kia/".$_FILES["img5"]["name"]);
move_uploaded_file($_FILES["img6"]["tmp_name"],"files/kia/".$_FILES["img6"]["name"]);
