...
switch ($op){
 ...
 function ambildata(){
       ...
       $sql1 ="select * from  tb_ktp WHERE uuid_reg='$nikuser' AND konvirm='1' ";
 ...
 function hitungkonfirm(){
        ...
        $nikuser= $_GET['nama'];
 $sql1 ="select * from   kk_penambahan_anak WHERE uuid_reg = '$nikuser' AND	konvirm = '1'    ";
        $q1= mysqli_query($koneksi, $sql1);
        $count = mysqli_num_rows($q1);
       while ($r1 = mysqli_fetch_array($q1)) ;
            $hasil[] =array(
  ...
  global $koneksi;
   ...
   $sql2 = " update  kk_penambahan_anak set konvirm= '0'
    where  	uuid_reg = '$nama' ";
