...
$uuidhtl01223 = substr(str_shuffle($permitted_chars1223), 0, 10);
$uuidhtlgcg = "rsn-$time11223$uuidhtl01223"; 



 $sql55 ="INSERT INTO `kritiksaran` (`id`, `uuid_reg`, `nama`, `pesan`, `create-at`) VALUES 
 ('$uuidhtlgcg', '$nikuser', '$nama', '$pesan', '$tanggal')";
