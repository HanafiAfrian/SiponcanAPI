...
switch ($op){
 ...
 case 'hitungkonfirm' :hitungkonfirm();break;
  case 'hitungkonfirmkurang' :hitungkonfirmkurang();break;
 ...
 function hitungkonfirm(){
        ...
        $nikuser= $_GET['nama'];
 $sql1 ="select * from  register WHERE nik = '$nikuser' AND	konvirm = '1'    ";
        $q1= mysqli_query($koneksi, $sql1);
        $count = mysqli_num_rows($q1);
       while ($r1 = mysqli_fetch_array($q1)) ;
            $hasil[] =array(
 ...
 function hitungkonfirmkurang(){
        global $koneksi;
       
        $nikuser= $_GET['nama'];
 $sql1 ="select * from  register WHERE nik = '$nikuser' AND	konvirm = '0'    ";
        $q1= mysqli_query($koneksi, $sql1);
        $count = mysqli_num_rows($q1);
       while ($r1 = mysqli_fetch_array($q1)) ;
            $hasil[] =array(
  ...
  global $koneksi;
   ...
   $sql2 = " update register set konvirm= '0'
    where  	nik = '$nama' ";
