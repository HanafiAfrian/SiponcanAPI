...
$tanggal = date('y-m-d H:i:s', strtotime($tanggal));
		...
		move_uploaded_file($_FILES["img1"]["tmp_name"],"files/ktpperubahan/".$_FILES["img1"]["name"]);
		move_uploaded_file($_FILES["img2"]["tmp_name"],"files/ktpperubahan/".$_FILES["img2"]["name"]);
