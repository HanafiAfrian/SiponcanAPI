...
$sql="INSERT INTO `surat_pindah` (`uuid`, `uuid_reg`, `nikpmhon`, `namapmhon`, `nokkpmhon`, `umurpmhon`, `kwn`, `klarifikasi_pindah`, `provinsiasl`, `kabupatenasl`, `kecamatanasl`, `kelurahanasl`, `alamatasl`, `kdposasl`, `provinsitj`, `kabupatentj`, `kectj`, `kltj`, `alamattj`, `kdpostj`, `alasanpindah`, `jenispindah`, `datakeluarga`, `datapindah`, `f_ktp`, `f_kk`, `f_bukunikah`, `create-at`, `status`, `konvirm`)
VALUES (
