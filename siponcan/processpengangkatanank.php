...
$nikayahangkat= addslashes($_POST['nikayahangkat']);
$nmayahangkat= addslashes($_POST['nmayahangkat']);
...
$tanggal = date('y-m-d H:i:s', strtotime($tanggal.'-1 hour'));
		...
		move_uploaded_file($_FILES["img1"]["tmp_name"],"files/pengangkatanank/".$_FILES["img1"]["name"]);
		move_uploaded_file($_FILES["img2"]["tmp_name"],"files/pengangkatanank/".$_FILES["img2"]["name"]);
		move_uploaded_file($_FILES["img3"]["tmp_name"],"files/pengangkatanank/".$_FILES["img3"]["name"]);
    	move_uploaded_file($_FILES["img4"]["tmp_name"],"files/pengangkatanank/".$_FILES["img4"]["name"]);
...
$sql="INSERT INTO `pengangkatanank` (`uuid`, `uuid_reg`, `nik_pm`, `nama_pm`, `nokk_pm`, `umur_pm`, `kwn_pm`, `nik_pr`, `nama_pr`, `temptlahir`, `tggllahir`, `jk`, `agama`, `anakke`, `noaktakel`, `tggl_terbit`, `penerbit`, `nikibukandung`, `namaibukandung`, `nikayahkandung`, `namaayahkandung`, `nikibuangkat`, `namaibuangkat`, `nikayahangkat`, `nmayahangkat`, `noputusanpengadilan`, `tggl_putusan`, `nmputusanpengadilan`, `temptputusanpengadilan`, `f_ktpayah`, `f_ktpibu`, `f_kkorangtuanangkat`, `f_kkasal`, `create-at`, `status`, `konvirm`)
