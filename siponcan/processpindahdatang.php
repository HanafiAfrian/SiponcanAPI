...
$tanggal = date('y-m-d H:i:s', strtotime($tanggal.'-1 hour'));
		...
		move_uploaded_file($_FILES["img1"]["tmp_name"],"files/kkpindahdatang/".$_FILES["img1"]["name"]);
		move_uploaded_file($_FILES["img2"]["tmp_name"],"files/kkpindahdatang/".$_FILES["img2"]["name"]);
...
$uuidhtl = "pmkpindahdtg-$time1$uuidhtl0";

		

$sql="INSERT INTO `kk_pindahdatang` (`uuid`, `uuid_reg`, `kkbarupmhon`, `nikpmhon`, `namapmhon`,
`nokkpmhon`, `umurpmhon`, `kwnpmhon`, `tujuanpmhon`, `f_surat_-pindah`, `f_ktp`, `create-at`, `status`, `konvirm`)
...
values ('$uuidhtlgch','Admin','$nikuser','Admin','$nikuser','Berkas Kartu Keluarga Pindah Datang Behasil di Upload','wr','0','$time','$tanggal')";
            $q152 = mysqli_query($koneksi,$sql45); 

$sq51 = " update chatgroup set pesan= 'Berkas Kartu Keluarga Pindah Datang Behasil di Upload',
                                tanggal = '$tanggal'
