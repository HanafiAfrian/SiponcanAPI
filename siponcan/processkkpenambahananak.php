...
";
	...
	$nm_anak= addslashes($_POST['nm_anak']);
	...
	$nm_ayah= addslashes($_POST['nm_ayah']);
...
values ('$uuidhtlgch','Admin','$nikuser','Admin','$nikuser','Berkas Kartu Keluarga Penambahan data Anak Behasil di Upload','wr','0','$time','$tanggal')";
