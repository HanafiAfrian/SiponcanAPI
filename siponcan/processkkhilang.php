...
$tanggal = date('y-m-d H:i:s', strtotime($tanggal.'-1 hour'));
		...
		move_uploaded_file($_FILES["img1"]["tmp_name"],"files/kkhilang/".$_FILES["img1"]["name"]);
		move_uploaded_file($_FILES["img2"]["tmp_name"],"files/kkhilang/".$_FILES["img2"]["name"]);
    	move_uploaded_file($_FILES["img3"]["tmp_name"],"files/kkhilang/".$_FILES["img3"]["name"]);
...
values ('$uuidhtlgch','Admin','$nikuser','Admin','$nikuser','Berkas Kartu Keluarga Hilang Behasil di Upload','wr','0','$time','$tanggal')";
