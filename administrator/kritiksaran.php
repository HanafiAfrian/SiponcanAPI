...
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clipboard-check-fill" viewBox="0 0 16 16">
  ...
  <main class="main-content ">
    ...
    <section id="main" style="padding: 20px; background-color:white;">
        ...
        <div>
             <a href="addadministrator.php">Tambah</a>
  ...
  <tr>
   ...
   <td class="table-primary w-20" style="font-family: 'Nunito', sans-serif; font-weight:bold;"> <center>NIK</td>
    <td class="table-primary w-20" style="font-family: 'Nunito', sans-serif;""> <center>Username</td>

    <td class="table-primary w-20" style="font-family: 'Nunito', sans-serif;""> <center>Pesan</td>
        <td class="table-primary w-20" style="font-family: 'Nunito', sans-serif;""> <center>Balas</td>
	 <td class="table-primary w-20" style="font-family: 'Nunito', sans-serif;""> <center>Tanggal</td>  
  </tr>
...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
	...
	$adjacents = "2"; 
$no='0';
	$result_count = mysqli_query($koneksi,"SELECT COUNT(*) As total_records FROM `kritiksaran`");
	$total_records = mysqli_fetch_array($result_count);
	$total_records = $total_records['total_records'];
    $total_no_of_pages = ceil($total_records / $total_records_per_page);
	$second_last = $total_no_of_pages - 1; // total page minus 1

    $result = mysqli_query($koneksi,"SELECT * FROM `kritiksaran`  ORDER BY 	 	id	 DESC");
    while($row = mysqli_fetch_array($result)){
		$no=$no+1;
	    echo "<tr>";

 	 echo "<td>$no</td>";
  echo "<td>".$row['uuid_reg']."</td>";
