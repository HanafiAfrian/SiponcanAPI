...
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clipboard-check-fill" viewBox="0 0 16 16">
  ...
  <tr>
   ...
   <td class="table-primary w-20" style="font-family: 'Nunito', sans-serif; font-weight:bold;"> <center>NIK</td>
    ...
    <td class="table-primary w-20" style="font-family: 'Nunito', sans-serif;""> <center>NAMA LENGKAP</td>
	    <td class="table-primary  w-20" style="font-family: 'Nunito', sans-serif;"> <center>NO TELEPON</td>
	  <td class="table-primary   w-20" style="font-family: 'Nunito', sans-serif;"> <center>EMAIL</td>
...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
	...
	$adjacents = "2"; 
$no='0';
	$result_count = mysqli_query($koneksi,"SELECT COUNT(*) As total_records FROM `register`");
	$total_records = mysqli_fetch_array($result_count);
	$total_records = $total_records['total_records'];
    $total_no_of_pages = ceil($total_records / $total_records_per_page);
	$second_last = $total_no_of_pages - 1; // total page minus 1

    $result = mysqli_query($koneksi,"SELECT * FROM `register`  ORDER BY 	uuid	 DESC");
	 ...
	 echo "<td>".$row['nik']."</td>";
	  echo "<td>".$row['nama']."</td>";
	   echo "<td>".$row['no_telp']."</td>";
	     echo "<td  style='width:80px'>".$row['email']."</td>";
