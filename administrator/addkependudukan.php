...
$substatus  	 = $_POST['substatus'];
  ...
  $sql1 = "INSERT INTO kekepndudukan VALUES(
      '',
      '".$nik."',
      '".$nokk."',
      '".$nama."',
...
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clipboard-check-fill" viewBox="0 0 16 16">
  ...
  <tr>
    <td>   <label for="jk" class="field">NIK</label></td>
    <td><input type="text" name="nik"  class="form-control" size='50'></td>
  ...
  <tr>
        ...
        <tr>
      <td>   <label for="jk" class="field">NO KK</label></td>
    <td><input type="text" name="nokk" class="form-control" size='50'></td>
    </tr>
    
        
        <tr>
   <td>   <label for="jk" class="field">NAMA</label></td>
    <td><input type="text" name="nama"   class="form-control" size='50' ></td>
        ...
        <tr>
   <td>   <label for="jk" class="field">NO TELEPON</label></td>
    <td><input type="text" name="notelpon"   class="form-control" size='50' ></td>
    </tr>
    
    
         <tr>
   <td>   <label for="jk" class="field">ALAMAT</label></td>
    <td><input type="text" name="alamat"   class="form-control" size='50' ></td>
    </tr>
    
    
        <tr>
   <td>   <label for="jk" class="field">PEKERJAAN</label></td>
    <td><input type="text" name="pekerjaan"   class="form-control" size='50' ></td>
    </tr>
        ...
        <tr>
                      <td>
                <label for="jk" class="field">MENIKAH / SINGLE </label>
                 </td>
                  <td>
                <select class="form-control"  name="status" id="jk">
        ...
        <tr>
                      <td>
                <label for="jk" class="field">STATUS </label>
                 </td>
                  <td>
                <select class="form-control"  name="substatus" id="jk">
  ...
  <a href="administrator.php"><input type="button" value="Batal"></a>
  </form>
