...
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clipboard-check-fill" viewBox="0 0 16 16">
  ...
  <path d="M4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z"/>
        ...
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Halaman Setting</h6>
        </li>
        <li class="nav-item">
  ...
  <main class="main-content ">
    ...
    <!-- main -->
    <section id="main" style="padding: 20px; background-color:white;">

        <div>
             <a href="addkependudukan.php">Tambah</a>
        <table id="tada" class="table table-hover mt-4">
              <thead class="thead-dark">
  <tr>

   <td class="table-primary w-20" style="font-family: 'Nunito', sans-serif; font-weight:bold;"> <center>NO</td>

    <td class="table-primary w-20" style="font-family: 'Nunito', sans-serif;""> <center>NIK</td>
        <td class="table-primary w-20" style="font-family: 'Nunito', sans-serif;""> <center>NO. KK</td>
        <td class="table-primary w-20" style="font-family: 'Nunito', sans-serif;""> <center>NAMA</td>
        
  <td class="table-primary w-20" style="font-family: 'Nunito', sans-serif;""> <center>JENIS KELAMIN</td>       
                    
  <td class="table-primary w-20" style="font-family: 'Nunito', sans-serif;""> <center> 	NO TELEPON</td>  
 <td class="table-primary w-20" style="font-family: 'Nunito', sans-serif;""> <center>ALAMAT</td>       
                   
     <td class="table-primary w-20" style="font-family: 'Nunito', sans-serif;""> <center>PEKERJAAN</td>        
          <td class="table-primary w-20" style="font-family: 'Nunito', sans-serif;""> <center>MEINKAH / SINGLE</td>   
          
  <td class="table-primary w-20" style="font-family: 'Nunito', sans-serif;""> <center> 	STATUS</td>  
  
    <td class="table-primary w-20" style="font-family: 'Nunito', sans-serif;""> <center>Aksi</td>
...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
	...
	$adjacents = "2"; 
$no='0';
	$result_count = mysqli_query($koneksi,"SELECT COUNT(*) As total_records FROM `kekepndudukan`");
	$total_records = mysqli_fetch_array($result_count);
	$total_records = $total_records['total_records'];
    $total_no_of_pages = ceil($total_records / $total_records_per_page);
	$second_last = $total_no_of_pages - 1; // total page minus 1

    $result = mysqli_query($koneksi,"SELECT * FROM `kekepndudukan`  ORDER BY 	id 	 DESC LIMIT $offset, $total_records_per_page");
    while($row = mysqli_fetch_array($result)){
	 ...
	 echo "<td>".$row['nokk']."</td>";	 
		 ...
		 echo "<td>".$row['nama']."</td>";	 
	 	 echo "<td>".$row['jk']."</td>";	 
	 	 echo "<td>".$row['notelpon']."</td>";	 
	 	 echo "<td>".$row['alamat']."</td>";	 
	 	 echo "<td>".$row['pekerjaan']."</td>";	 
	 	 echo "<td>".$row['status']."</td>";	 
	  	 echo "<td>".$row['substatus']."</td>";	 
	 
 echo "<td><center><a href='editadministrator.php?id_login=".$row['id_login']."'>Ubah</a> |";
    echo "<a href='delleteadministrator.php?id_login=".$row['id_login']."'>Hapus</a></td></center>";
