...
<body style="min-height:0px">
    <div class="container">
        ...
        <h3 class="text-center mb-4">Pelayanan Pembuatan Kartu Identitas Anak</h3>
 ...
 <div class="col-lg-6">
            ...
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="namapr" id="namapr" aria-describedby="emailHelp" required>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="temptlahir" id="temptlahir" aria-describedby="emailHelp" required>
              </div>
            </div>
            <div class="col-lg-6">

              <div class="form-group">
                <label for="pilih_tanggal_pesan" class="field">Tanggal Terbit Akta Lahir</label>
            ...
            <div class="col-lg-6">
              ...
              <div class="form-group">
                <label for="exampleInputEmail1" name="selectedcat" class="field">Jenis Kelamin</label>
            ...
            <div class="col-lg-6">
              <div class="form-group">
                <label for="exampleInputEmail1" name ="selectedcat1" class="field">Agama</label>
            ...
            <div class="col-lg-6">
              ...
              <div class="form-group">
                <label for="noakta" class="field">Nomor Akta Kelahiran</label>
                <input type="text" class="form-control" name="noaktakel" id="noaktakel" aria-describedby="emailHelp" required>
              </div>
            </div>
            <div class="col-lg-6">

              <div class="form-group">
                <label for="namaayah" class="field">Nama Ayah</label>
            ...
            <div class="col-lg-6">
              ...
              <div class="form-group">
                <label for="namaibu" class="field">Nama Ibu</label>
  ...
  <div class="col-lg-6 mt-4">
            ...
            <div class="col-lg-6 mt-4">
              <div class="form-group">
                <label for="" class="field">Akta Kelahiran</label>
            ...
            <div class="col-lg-6 mt-4">
              <div class="form-group">
                <label for="" class="field">Foto Anak</label>
                <input type="file" name="img5" class="form-control-file btn btn-outline-secondary" id="exampleFormControlFile1" required>
                <small class="field" style="font-size: 12px;">Bagi diatas 5 tahun, latar biru untuk
                  tahun lahir anak genap atau merah untuk
                  tahun
                  lahir anak ganjil (*.jpg *.png *.pdf)</small>
              </div>
            </div>
            <div class="col-lg-6 mt-4">
              <div class="form-group">
                <label for="" class="field mb-2" style="padding-bottom: 20px;
                                    text-overflow: ellipsis;    white-space: nowrap;">Perpanjangan
                  KIA/KIA Hilang/Keterangan Lainnya</label>
                <input type="file" name="img6" class="form-control-file btn btn-outline-secondary" id="exampleFormControlFile1" required>
                <small class="field" style="font-size: 12px;">Optional (*.jpg *.png *.pdf)</small>
              </div>
            </div>
...
move_uploaded_file($_FILES["img1"]["tmp_name"],"siponcan/files/kia/".$_FILES["img1"]["name"]);
move_uploaded_file($_FILES["img2"]["tmp_name"],"siponcan/files/kia/".$_FILES["img2"]["name"]);

move_uploaded_file($_FILES["img3"]["tmp_name"],"siponcan/files/kia/".$_FILES["img3"]["name"]);
move_uploaded_file($_FILES["img4"]["tmp_name"],"siponcan/files/kia/".$_FILES["img4"]["name"]);
move_uploaded_file($_FILES["img5"]["tmp_name"],"siponcan/files/kia/".$_FILES["img5"]["name"]);
move_uploaded_file($_FILES["img6"]["tmp_name"],"siponcan/files/kia/".$_FILES["img6"]["name"]);
...
$uuidhtl = "pmkia-$time1$uuidhtl0";

		

$sql="INSERT INTO `kia` (`uuid`, `uuid_reg`, `nik_pm`, `nama_pm`, `nokk_pm`, `umur_pm`, `kwn_pm`, `nik_pr`, `nama_pr`, `temptlahir`, `tggllahir`, `jk`, `agama`, `noaktakel`, `namaayah`, `namaibu`, `f_ktpayah`, `f_ktpibu`, `f_aktakel`, `f_kkasli`, `f_fotoanak`, `f_pjkia`, `create-at`, `status`, `konvirm`)
