  ...
  <body>
    <section>
        ...
        <div class="container">
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-6 mt-4">
                                ...
                                <label for="">Foto Anak</label>
                                    <input type="file" class="form-control-file btn btn-outline-secondary"
                                    id="exampleFormControlFile1" required>
                                    <small>Bagi diatas 5 tahun, latar biru untuk tahun lahir anak genap atau merah untuk tahun
                                        lahir anak ganjil (*.jpg *.png *.pdf)</small>
                                </div>
                            </div>
                            <div class="col-lg-6 mt-4">
                                <div class="form-group">
                                <label for="">Perpanjangan KIA/KIA Hilang/Keterangan Lainnya</label>
                                    <input type="file" class="form-control-file btn btn-outline-secondary"
                                    id="exampleFormControlFile1" required>
                                    <small>Optional (*.jpg *.png *.pdf)</small>
                                </div>
                            </div>
            ...
            <form action="">
              <a class="mt-4 text-dark" href="kia"> <i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
