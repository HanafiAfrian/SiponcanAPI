...
<body style="min-height:0px">
    <div class="container">
        ...
        <h3 class="text-center mb-4">Pelayanan Pembuatan Kartu Tanda Penduduk Perubahan</h3>
  ...
  <div class="col-lg-6">
         ...
         <option value="Budha">Budha</option>
                  <option value="Konghucu">Konghucu</option>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="alasanpengajuan" class="field">Alasan Perubahan</label>
                                <input type="text" class="form-control" name="alasanpengajuan" id="alasanpengajuan" aria-describedby="emailHelp" required>
                            </div>
                        </div>
                ...
                <div class="page">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mt-4">
                            <div class="form-group">
                                <label for="" class="field">Foto Kartu Keluarga Terbaru Setelah berubah</label>
                        ...
                        <div class="col-lg-6 mt-4">
                            <div class="form-group">
                                <label for="" class="field">Foto KTP Lama Asli yang belum berubah</label>
...
$alasanpengajuan= addslashes($_POST['alasanpengajuan']);
...
$tanggal = date('y-m-d H:i:s', strtotime($tanggal));
		...
		move_uploaded_file($_FILES["img1"]["tmp_name"],"siponcan/files/ktpperubahan/".$_FILES["img1"]["name"]);
		move_uploaded_file($_FILES["img2"]["tmp_name"],"siponcan/files/ktpperubahan/".$_FILES["img2"]["name"]);
...
$uuidhtl = "pmktppr-$time1$uuidhtl0";

		

$sql="INSERT INTO `ktpperubahan` (`uuid`, `uuid_reg`, `nik_pm`, `nama_pm`, `nokk_pm`, `umur_pm`, `kwn_pm`, `nik_pr`, `nama_pr`, `temptlahir`, `tggllahir`, `jk`, `agama`, `alasan`, `f_kkperubahan`, `f_kkasli`, `create-at`, `status`, `konvirm`)
