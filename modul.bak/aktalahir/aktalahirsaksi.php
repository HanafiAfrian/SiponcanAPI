...
<section>
    ...
    <div class="container" style="padding: 10px; border-radius: 10px;">
        ...
        <form action="aktalahir-ayah" Method="POST">
            <div class="row">
...
<input type="hidden" class="form-control" name="kwnpmhon" value ="<?php echo $kwnpmhon ?>">
            ...
            <div class="row mt-4">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="umursaksi2" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <a href="aktalahir-ayah"><button id="save" class="btn btn-primary">Next</button></a>
        </form>

        <form action="">
            <a class="mt-4 text-dark" href="aktalahir"> <i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
            <div class="dropdown-divider mt-4"></div>
        </form>
    </div>
</section>