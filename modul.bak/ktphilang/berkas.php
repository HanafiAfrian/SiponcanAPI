  ...
  <body>
    <section>
        ...
        <div class="container">
                            ...
                            <div class="col-lg-6 mt-4">
                              ...
                              <div class="col-lg-6 mt-4">
                                ...
                                <label for="">Surat Ket. Hilang dari Polisi</label>
                                    <input type="file" class="form-control-file btn btn-outline-secondary"
                                    id="exampleFormControlFile1" required>
                                    <small>jika hilang maka wajib upload / photo surat ket. hilang dari kepolisian (*.jpg *.png *.pdf)</small>
                                </div>
            ...
            <form action="">
              <a class="mt-4 text-dark" href="ktp-hilang"> <i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
