...
<body style="min-height:0px">
    <div class="container">
        ...
        <h3 class="text-center mb-4">Permohonan Pembuatan Pisah KK</h3>
    ...
    ">
                ...
                <div class="page">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mt-4">
                            <div class="form-group">
                                <label for="" class="field">KK Lama</label>
                        ...
                        <div class="col-lg-6 mt-4">
                            <div class="form-group">
                                <label for="" class="field">Surat Keterangan Cerai (Jika Pisah Karena Perceraian)</label>
                        ...
                        <div class="col-lg-6 mt-4">
                            <div class="form-group">
                                <label for="" class="field">Surat Keterangan Domisili (Jika Pisah Karena Perpindahan)</label>
...
$tanggal = date('y-m-d H:i:s', strtotime($tanggal));
		...
		move_uploaded_file($_FILES["img1"]["tmp_name"],"siponcan/files/kkpisah/".$_FILES["img1"]["name"]);
		move_uploaded_file($_FILES["img2"]["tmp_name"],"siponcan/files/kkpisah/".$_FILES["img2"]["name"]);
    	move_uploaded_file($_FILES["img3"]["tmp_name"],"siponcan/files/kkpisah/".$_FILES["img3"]["name"]);
    	move_uploaded_file($_FILES["img4"]["tmp_name"],"siponcan/files/kkpisah/".$_FILES["img4"]["name"]);
...
$uuidhtl = "pmkkpsh-$time1$uuidhtl0";

		

$sql="INSERT INTO `kk_pisah` (`uuid`, `uuid_reg`, `nik_pm`, `nama_pm`, `nokk_pm`, `umur_pm`, `kwn_pm`, `f_ktp`, `f_kklama`, `f_ket_cerai`, `f_ket_pindah`, `create-at`, `status`, `konvirm`)
...
values ('$uuidhtlgch','Admin','$nikuser','Admin','$nikuser','Berkas Kartu Keluarga Hilang atau Rusak Behasil di Upload','wr','1','$time','$tanggal')";
            $q152 = mysqli_query($koneksi,$sql45); 

$sq51 = " update chatgroup set pesan= 'Berkas Kartu Keluarga Hilang atau Rusak Behasil di Upload',
                                tanggal = '$tanggal'
