...
<body style="min-height:0px">
    <div class="container">
        ...
        <h3 class="text-center mb-4">Pelayanan Pembuatan Kartu Tanda Penduduk Rusak</h3>
  ...
  <div class="col-lg-6">
         ...
         <option value="Budha">Budha</option>
                  <option value="Konghucu">Konghucu</option>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="rusakkarena" class="field">Rusak Kerana Apa</label>
                ...
                <div class="page">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mt-4">
                            <div class="form-group">
                                <label for="" class="field">Foto KTP Asli yang Rusak</label>
...
$tanggal = date('y-m-d H:i:s', strtotime($tanggal));
		...
		move_uploaded_file($_FILES["img1"]["tmp_name"],"siponcan/files/ktprusak/".$_FILES["img1"]["name"]);
		move_uploaded_file($_FILES["img2"]["tmp_name"],"siponcan/files/ktprusak/".$_FILES["img2"]["name"]);
