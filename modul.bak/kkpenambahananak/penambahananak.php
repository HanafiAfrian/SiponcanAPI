...
<body style="min-height:0px">
    <div class="container">
        ...
        <h3 class="text-center mb-4"> Peristiwa Penting Kelahiran</h3>
               <h6 class="text-center mb-4">Penambahan Anak Di KK</h6>
    ...
    ">
                ...
                <div class="page">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="nm_anak" class="field">Nama Lengkap</label>
                                <input type="text" class="form-control" name="nm_anak" id="nm_anak" aria-describedby="emailHelp" required>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="jk" class="field">Jenis Kelamin Anak</label>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="temp_lahir" class="field">Tempat Lahir</label>
                                <input type="text" class="form-control" id="temp_lahir" name="temp_lahir" aria-describedby="emailHelp" required>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="pilih_tanggal_pesan" class="field">Tanggal Lahir</label>
                                <input type="date" class="form-control" id="pilih_tanggal_pesan" name="pilih_tanggal_pesan" aria-describedby="emailHelp">
                            </div>
                        </div>

                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="pilih_jam_pesan" class="field">Waktu Lahir</label>
                                <input type="time" name="pilih_jam_pesan" data-maxlength="16" data-minlength="16" class="form-control" id="pilih_jam_pesan" aria-describedby="emailHelp" required>
                            </div>
                        </div>

                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="jk" class="field">Golongan Darah</label>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="jk" class="field">Agama</label>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="shdk" class="field text-danger">SHDK</label>
                                <input type="text" class="form-control" name="shdk" id="shdk" aria-describedby="emailHelp"  value="Anak" disabled>
                            </div>
                        </div>

                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="jk" class="field">Kelainan Fisik dan Mental</label>
 ...
 <div class="col-lg-6">
                            <div class="form-group">
                                <label for="nm_ayah" class="field">Nama Ayah</label>
                                <input type="text" class="form-control" name="nm_ayah" id="nm_ayah" aria-describedby="emailHelp"  required>
                            </div>
                        </div>

                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="nm_ibu" class="field">Nama Ibu</label>
                                <input type="text" class="form-control" name="nm_ibu" id="nm_ibu" aria-describedby="emailHelp"  required>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mt-4">
                            <div class="form-group">
                                ...
                                <small class="field text-left" style="font-size: 12px;">dari RS/Puskesmas/Klinik/Bidan (*.jpg *.png *.pdf)</small>
                            </div>
                        </div>
                        <div class="col-lg-6 mt-4">
                            <div class="form-group">
                                <label for="" class="field">Surat Nikah / Akta Kawin</label>
...
$tanggal = date('y-m-d H:i:s');
		...
		move_uploaded_file($_FILES["img1"]["tmp_name"],"siponcan/files/kkpenambahananak/".$_FILES["img1"]["name"]);
		move_uploaded_file($_FILES["img2"]["tmp_name"],"siponcan/files/kkpenambahananak/".$_FILES["img2"]["name"]);
		move_uploaded_file($_FILES["img3"]["tmp_name"],"siponcan/files/kkpenambahananak/".$_FILES["img3"]["name"]);
		move_uploaded_file($_FILES["img4"]["tmp_name"],"siponcan/files/kkpenambahananak/".$_FILES["img4"]["name"]);
...
'PDAPKK',
'Kartu Keluarga ',
'Peristiwa Penting Penambahan KK Kelahiran,
'$tanggal',
'$status'
)";
...
values ('','Admin','$nikuser','Admin','$nikuser','Berkas Kartu Keluarga Penambahan data Anak Behasil di Upload','wr','1','$time','$tanggal')";
