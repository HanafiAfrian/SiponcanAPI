...
<body style="min-height:0px">
    <div class="container">
        ...
        <h3 class="text-center mb-4">Pelayanan Pembuatan Kartu Keluarga Hilang</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="noketpolisi" data-maxlength="16" data-minlength="16" class="form-control" id="noketpolisi" aria-describedby="emailHelp" required>
                            </div>
                        </div>

  <div class="col-lg-6">
                            <div class="form-group">
                                <label for="nosuratpenitera" class="field">Tanggal Hilang</label>
                ...
                <div class="page">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mt-4">
                            <div class="form-group">
                                <label for="" class="field">Surat Ket. Hilang dari Polisi</label>
                                <input type="file" name="img3" class="form-control-file btn btn-outline-secondary" id="uploadakm2" required>
                                <small class="field text-left" style="font-size: 12px;">(*.jpg *.png *.pdf)</small>
                            </div>
                        </div>
...
include('config/koneksi.php');
	...
	
	{
		...
		$noketpolisi=$_POST['noketpolisi'];
		$pilih_tanggal_pesan=$_POST['pilih_tanggal_pesan'];
		$lokasihilang=$_POST['lokasihilang'];
...
$tanggal = date('y-m-d H:i:s', strtotime($tanggal.'-1 hour'));
		...
		move_uploaded_file($_FILES["img1"]["tmp_name"],"siponcan/files/kkhilang/".$_FILES["img1"]["name"]);
		move_uploaded_file($_FILES["img2"]["tmp_name"],"siponcan/files/kkhilang/".$_FILES["img2"]["name"]);
    	move_uploaded_file($_FILES["img3"]["tmp_name"],"siponcan/files/kkhilang/".$_FILES["img3"]["name"]);
...
$uuidhtl = "pmkkhl-$time1$uuidhtl0";

		

$sql="INSERT INTO `kk_hilang` (`uuid`, `uuid_reg`, `nik_pm`, `nama_pm`, `nokk_pm`, `umur_pm`, `kwn_pm`, `nokk2`, `namakepkel`, `noketpolisi`, `tggl_hilang`, `lokasihilang`, `f_ktp`, `f_kkrusak`, `f_surat_ket`, `create-at`, `status`, `konvirm`)
...
values ('$uuidhtlgch','Admin','$nikuser','Admin','$nikuser','Berkas Kartu Keluarga Hilang Behasil di Upload','wr','1','$time','$tanggal')";
            $q152 = mysqli_query($koneksi,$sql45); 

$sq51 = " update chatgroup set pesan= 'Berkas Kartu Keluarga Hilang  Behasil di Upload',
                                tanggal = '$tanggal'
