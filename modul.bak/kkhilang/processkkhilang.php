...
$sql="INSERT INTO `kk_hilang` (`uuid`, `uuid_reg`, `nik_pm`, `nama_pm`, `nokk_pm`, `umur_pm`, `kwn_pm`, `f_ktp`, `f_kkrusak`, `f_surat_ket`, `create-at`, `status`, `konvirm`)
...
values ('','Admin','$nikuser','Admin','$nikuser','Berkas Kartu Keluarga Hilang atau Rusak Behasil di Upload','wr','0','$time','$tanggal')";
