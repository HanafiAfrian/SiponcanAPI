...
<body style="min-height:0px">
    <div class="container">
        ...
        <h3 class="text-center mb-4"> Peristiwa Penting Kepindahan</h3>
   ...
   <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="kdpostj" class="field">Kode POS</label>
                ...
                <div class="page">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mt-4">
                            <div class="form-group">
                                <label for="" class="field">Buku Nikah / Akte Kawin</label>
...
$tanggal = date('y-m-d H:i:s', strtotime($tanggal.'-1 hour'));
		...
		move_uploaded_file($_FILES["img1"]["tmp_name"],"siponcan/files/kkpppindah/".$_FILES["img1"]["name"]);
		move_uploaded_file($_FILES["img2"]["tmp_name"],"siponcan/files/kkpppindah/".$_FILES["img2"]["name"]);
		move_uploaded_file($_FILES["img3"]["tmp_name"],"siponcan/files/kkpppindah/".$_FILES["img3"]["name"]);
...
values ('$uuidhtlgch','Admin','$nikuser','Admin','$nikuser','Berkas  Surat Pindah Behasil di Upload','wr','1','$time','$tanggal')";
