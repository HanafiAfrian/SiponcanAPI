...
<section>
    ...
    <h3 class="text-center">Permohonan Pembuatan KK Baru </h3>
       ...
       <form action="modul/pindahdtg/processpindahdatang.php" Method="post" enctype="multipart/form-data">
            <section>
     ...
     <input type="Text" class="form-control" name="nokkpmhon" value ="<?php echo $nokkpmhon ?>">
      <input type="Text" class="form-control" name="umurpmhon" value ="<?php echo $umurpmhon ?>">
       <input type="Text" class="form-control" name="kwnpmhon" value ="<?php echo $kwnpmhon ?>">
        <input type="Text" class="form-control" name="tujuanpmhon" value ="<?php echo $tujuanpmhon ?>">
        ...
        <form action="">
            <a class="mt-4 text-dark" href="kk-pindah-datang"> <i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
