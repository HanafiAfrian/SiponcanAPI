...
<body style="min-height:0px">
    <div class="container">
        ...
        <h3 class="text-center mb-4">Pelayanan Pembuatan Akta Pengakuan Anak</h3>
...
$tanggal = date('y-m-d H:i:s', strtotime($tanggal.'-1 hour'));
		...
		move_uploaded_file($_FILES["img1"]["tmp_name"],"siponcan/files/pengakuananak/".$_FILES["img1"]["name"]);
		move_uploaded_file($_FILES["img2"]["tmp_name"],"siponcan/files/pengakuananak/".$_FILES["img2"]["name"]);
...
$sql="INSERT INTO `pengakuananak` (`uuid`, `uuid_reg`, `nik_pm`, `nama_pm`, `nokk_pm`, `umur_pm`, `kwn_pm`, `nik_pr`, `nama_pr`, `temptlahir`, `tggllahir`, `jk`, `anakke`, `noaktakel`, `tggl_terbit`, `penerbit`, `f_ktpayah`, `f_ktpibu`, `create-at`, `status`, `konvirm`)
