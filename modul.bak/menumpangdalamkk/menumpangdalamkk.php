...
<body style="min-height:0px">
    <div class="container">
        ...
        <h3 class="text-center mb-4">Permohonan Pembuatan Menumpang Dalam KK</h3>
    ...
    ">
                ...
                <div class="page">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mt-4">
                            <div class="form-group">
                                <label for="" class="field">Surat Ket. Pindah Datang Untuk Numpang KK</label>
...
$tanggal = date('y-m-d H:i:s', strtotime($tanggal));
		...
		move_uploaded_file($_FILES["img1"]["tmp_name"],"siponcan/files/numpangdalamkk/".$_FILES["img1"]["name"]);
		move_uploaded_file($_FILES["img2"]["tmp_name"],"siponcan/files/numpangdalamkk/".$_FILES["img2"]["name"]);
    	move_uploaded_file($_FILES["img3"]["tmp_name"],"siponcan/files/numpangdalamkk/".$_FILES["img3"]["name"]);
...
$uuidhtl = "pmkknmpg-$time1$uuidhtl0";

		

$sql="INSERT INTO `kk_numpangdalamkk` (`uuid`, `uuid_reg`, `nik_pm`, `nama_pm`, `nokk_pm`, `umur_pm`, `kwn_pm`, `f_ktp`, `f_kkrusak`, `f_surat_ket`, `create-at`, `status`, `konvirm`)
...
'KKNPGKK',
'Kartu Keluarga',
'Kartu Keluarga Numpang dalam KK',
'$tanggal',
'$status'
)";
...
values ('$uuidhtlgch','Admin','$nikuser','Admin','$nikuser','Berkas Menumpang Dalam KK Behasil di Upload','wr','1','$time','$tanggal')";
            $q152 = mysqli_query($koneksi,$sql45); 

$sq51 = " update chatgroup set pesan= 'Berkas Menumpang Dalam KK Behasil di Upload',
                                tanggal = '$tanggal'
